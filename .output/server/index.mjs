...
import { eventHandler as eventHandler$1, toWebRequest, getResponseStatus, getEvent, createStartHandler } from '@tanstack/start-server-core';
...
const appConfig = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/ianworley/code/fastbreak","order":0,"outDir":"/Users/ianworley/code/fastbreak/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"src/entry-client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/Users/ianworley/code/fastbreak","outDir":"/Users/ianworley/code/fastbreak/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"src/entry-server.tsx","link":{"client":"client"},"root":"/Users/ianworley/code/fastbreak","base":"/","outDir":"/Users/ianworley/code/fastbreak/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start-server-functions-handler/dist/esm/index.js","root":"/Users/ianworley/code/fastbreak","outDir":"/Users/ianworley/code/fastbreak/.vinxi/build/server","order":3}],"server":{"experimental":{"asyncContext":true}},"root":"/Users/ianworley/code/fastbreak"};
					const buildManifest = {"client":{"virtual:$vinxi/handler/client":{"file":"assets/client-DhtesRXP.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true}},"ssr":{"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true}},"server":{"virtual:$vinxi/handler/server":{"file":"server.js","name":"server","src":"virtual:$vinxi/handler/server","isEntry":true}}};
...
const assets = {
  "/court.png": {
    "type": "image/png",
    "etag": "\"26f6-jouz8SkSQ3WLQE04gvOn3qz1Z+k\"",
    "mtime": "2026-05-31T19:47:50.781Z",
    "size": 9974,
    "path": "../public/court.png"
  },
  "/favicon.ico": {
    "type": "image/vnd.microsoft.icon",
    "etag": "\"3c2e-yQeRlWEy7pIE8OebZBxeA/UKE4Y\"",
    "mtime": "2026-05-31T19:47:50.781Z",
    "size": 15406,
  ...
  "/_build/.vite/manifest.json": {
    ...
    "etag": "\"ab-7V1Y/7ChMVquWzmyN3V/0SxquP4\"",
    "mtime": "2026-05-31T19:47:50.781Z",
    "size": 171,
    "path": "../public/_build/.vite/manifest.json"
  },
  "/_build/assets/client-DhtesRXP.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3bcc0-NammwWRrSTiduaGLDiCZCJXlDe8\"",
    "mtime": "2026-05-31T19:47:50.782Z",
    "size": 244928,
    "path": "../public/_build/assets/client-DhtesRXP.js"
  }
};
...
const _uZYEbi = eventHandler((event) => {
...
var m = defineHandlerCallback(({ router: r, responseHeaders: t }) => renderRouterToString({ router: r, responseHeaders: t, children: jsx(l, { router: r }) }));
const s = createClerkHandler(createStartHandler)(m);

const handlers = [
  { route: '', handler: _uZYEbi, lazy: false, middleware: true, method: undefined },
  { route: '/_server', handler: q, lazy: false, middleware: true, method: undefined },
  { route: '/', handler: s, lazy: false, middleware: true, method: undefined }
];
