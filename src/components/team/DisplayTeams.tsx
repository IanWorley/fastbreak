...
import CreateTeamDenied from "~/components/team/CreateTeamDenied";
import DeleteModel from "~/components/team/DeleteTeamModel";
  ...
  return (
    ...
    >
      ...
      <div className="flex h-full w-full gap-3">
        <Link className="h-full w-full" to={`/team/$id/game`} params={{ id: team.id }}>
