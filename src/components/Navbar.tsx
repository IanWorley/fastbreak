...
import { SignInButton, UserButton, useUser } from "@clerk/tanstack-start";
        ...
        >
          <ul className="items-center justify-center space-y-8 md:flex md:justify-end md:space-x-6 md:space-y-0 md:p-4">
            ...
            {viewingTeam && (
              <>
                <li className="hover:cursor-pointer hover:text-indigo-600">
                  <Link to="/team/$id/game" params={{ id: teamId! }}>Games</Link>
                </li>
                <li className="hover:cursor-pointer hover:text-indigo-600">
                  <Link to="/team/$id/player" params={{ id: teamId! }}>Roster</Link>
                </li>
              </>
            )}
          </ul>
